...
public class MainActivity extends AppCompatActivity implements RoutingListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private static final LatLngBounds BOUNDS_KERALA = new LatLngBounds(new LatLng(10.5276416, 76.2144349),
            new LatLng(10.5276416, -76.2144349));
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        mAdapter = new PlaceAutoCompleteAdapter(this, android.R.layout.simple_list_item_1,
                mGoogleApiClient, BOUNDS_KERALA, null);
        ...
        * */
        ...
        CameraUpdate center = CameraUpdateFactory.newLatLng(new LatLng(10.5276416, 76.2144349));
